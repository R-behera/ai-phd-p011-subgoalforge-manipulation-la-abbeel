...
This project targets the intersection of **Robot learning, RL, imitation learning** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Pieter Abbeel's research area.
...
Advisor-specific slice: **Robot learning, RL, imitation learning**.
